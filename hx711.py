...
class HX711:
    ...
    def read_average(self, times=3):
        ...
        # remove the outliers, then take the mean of the remaining set.
        valueList = []
        ...
        # We'll be trimming 20% of outlier samples from
        # top and bottom of collected set.
    ...
    # A median-based read method,
    # might help when getting random value spikes
    ...
    def set_reference_unit_A(self, reference_unit):
        ...
        if reference_unit == 0:
            raise ValueError(
                "HX711::set_reference_unit_A() "
                "can't accept 0 as a reference unit!"
            )
